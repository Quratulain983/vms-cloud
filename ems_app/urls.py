...
from .views import total_admin, admin_detail, total_project_user, get_total_gateways_user, admin_detail_superadmin, create_or_update_subscription, create_admin, create_admincr, create_superadmincr, fetching_user, Get_User_Project_Count, selected_analyzer_data
from .views import  get_unassigned_users, assign_user_to_admin, get_admin_users,  get_user_gateways
from . import views
urlpatterns = [
